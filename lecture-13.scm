...
;;; The Church-Rosser Theorem -> if we apply x and y to a to get b and c, we can apply y to a and x to b and both will equal d.
;;;
...
;;; note that as an alternative to Lambda Calculus, we can use combinator logic/SKI-calculus, which only uses the combinators I, K and S
;;; Combinator Logic is also Turing complete.
